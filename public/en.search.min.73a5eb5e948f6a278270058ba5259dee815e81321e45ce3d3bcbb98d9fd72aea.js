...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5294f6b2e4c5a0c8b06053f5d58cd0a073f337cfa1430abc200de2f7cc89bea7.js',function(){input.required=false;search();});}
